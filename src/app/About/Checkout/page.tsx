...
export default function Checkout() {
  return (
        ...
        <div className="lg:w-2/3 pr-0 lg:pr-8 ">
          ...
          <form>
            ...
            <div className="mb-4 text-gray-500">
              ...
              <select
                id="country"
                className="w-[600px] sm:[400px] h-[60px] border border-[#9F9F9F] rounded-lg p-2 "
                >
    ...
    <div className=' flex lg:flex  sm:grid sm:gap-8 sm:mt-24  items-center justify-center w-full h-[400px] space-x-3 bg-[#FAF4F4] mt-6'>
