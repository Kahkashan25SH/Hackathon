...
import { AiFillTwitterCircle, AiTwotoneCloseCircle } from 'react-icons/ai'
...
export default function Cartsidebar() {
  return (
     ...
     <div className='bg-[#00000033]'>
      ...
      <div className='flex-wrap flex-row flex-1 m w-full h-[820px] border-b'>
        <div className=" w-full h-[730.87px]">
          <div className=' flex w-[553px] h-[500px] space-x-8'>
            <div className=" w-[76px] h-[416px] space-y-6">
          ...
          {/* Product Details */}
          <div className='absolute right-2 top-1/4 py-2 w-[606px] h-[730px]'>
            ...
            <div className="mt-6 flex items-center space-x-4">
              ...
              <button className="px-6 py-3 rounded-[15px] border border-black hover:bg-[#FFF9E5] font-normal text-base">
      ...
      <div className=' w-full h-[700px] mx-auto  border-b border-[#D9D9D9]'>
        ...
        <div className=' flex w-[1239px] h-[348px] gap-6 mt-8'>
      ...
      <div className='w-full h-[400px] flex justify-center items-center mt-8 '>
       ...
       <div className='absolute right-2 top-2'>
        <div className='bg-white px-3 py-7'>
          ...
          <div className='flex justify-between'>
            <button className='border border-black px-5 py-1 rounded-3xl hover:text-blue-800 hover:border-blue-900'>View Cart</button>
  ...
  // import Link from 'next/link'
// import React from 'react'
// import Shop from "@/app/Shop/Asgaard-sofa/page"
// import { CiLock } from "react-icons/ci";
// import Image from 'next/image';
...
//         <div className='  bg-slate-100 rounded-xl px-5  py-5'>
//           <div className=' mb-80  '>
//             <div className='flex justify-between gap-32 text-2xl   text-black font-bold px-5  '>
//               <h1>Shopping Cart  </h1>
//               <CiLock />
...
//           <div className='flex justify-between'>
//             <button className='border border-black px-5 py-1 rounded-3xl hover:text-blue-800 hover:border-blue-900'>View Cart</button>
//             <button className='border border-black px-5 py-1 rounded-3xl hover:text-blue-800 hover:border-blue-900'>checkout</button>
//           </div>
//         </div>
//       </div>
